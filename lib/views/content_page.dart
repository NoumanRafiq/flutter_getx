...
class ContentPage extends StatelessWidget {
  ...
  void waitForScreen({required DataController dataController, required bool loadingVal}) {
  ...
  Widget build(BuildContext context) {
    ...
    int _currentIndex = 0;
    return Obx(()=>  _dataController.isLoading
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              Get.toNamed(AppRoutes.getDetailPage());
                            },
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5),
                                  Divider(thickness: 1.0, color: Colors.white38,),
                                  Row(
                                    children: [
                                      for (int i = 0; i < 1; i++)
                                        Container(
